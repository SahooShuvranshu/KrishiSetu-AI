...
const staticTranslations = {
  en: {
    ...
    paddyCotton: "Paddy, Cotton...",
    onlineMode: "Online Mode",
    onlineDesc: "Full AI diagnosis available. Weather and market data updating.",
    weather: "Weather",
  ...
  or: {
    ...
    autoDetectLocation: "�ଟୋ-ଡିଟେକ୍ଟ ଜୋନ୍",
    appInfo: "ଆପ୍ ଇନ୍ଫୋ",
  ...
  hi: {
    ...
    paddyCotton: "धान, कपाहा...",
    onlineMode: "ऑनलाइन मोड",
    onlineDesc: "पूर्ण एआई निदान उपलब्ध। मौसम और बाजार भाव अपडेट हो रहे हैं।",
    weather: "मौसम",
